...
greeting_responses = ['Hello! How can I help you?',
                      ...
                      'Hi, you can ask me anything regarding SUDARSAN KUMAR.',
                      'Hey! wanna know about SUDARSAN KUMAR? Just ask away!',
                       'Hello! How can I assist you today?',
            'Hey there! What can I do for you?',
            'Hi! Feel free to ask me anything about SUDARSAN KUMAR.',
            'Hey! Ready to learn about SUDARSAN KUMAR? Ask me anything!',
            'Hi there! What brings you here today?',
            'Hello! Excited to talk about SUDARSAN KUMAR?',
            'Hey! Need information about SUDARSAN KUMAR? I\'m here to help.',
            'Hi! Curious about SUDARSAN KUMAR? Ask away!',
            'Hello! Want to know more about SUDARSAN KUMAR? Ask me!',
            'Hey there! I\'m here to answer your questions about SUDARSAN KUMAR.']
...
question_answers ={
    'what are you': 'I am SUDARSAN KUMAR, a chatbot designed to answer questions regarding Brac.',
    'who are you': 'I am UDARSAN KUMAR, an AI-powered chatbot programmed to assist with queries about Brac.',
...
continue_chat = True
print('Hi! I am SUDARSAN KUMAR. I can tell you a joke😉!! ')
...
while continue_chat:
    ...
    if user_input != 'bye':
        if user_input in conversation_replies:
            ...
            if response:
                print('SUDARSAN KUMAR: ' + response)
            else:
                print('SUDARSAN KUMAR: Sorry, I did not understand that.')
    else:
        continue_chat = False
        print('SUDARSAN KUMAR: Bye, take care, stay home and stay safe!')